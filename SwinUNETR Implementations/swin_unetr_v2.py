...
os.environ["MPLCONFIGDIR"] = "/scratch/u/uanazodo/spark7/SWIN_UNETR_v2/SLURM_OUT"
...
root_dir = "/scratch/u/uanazodo/spark7/SWIN_UNETR_v2/SWIN_UNETR_V2_MODEL"
print(root_dir)
...
def save_checkpoint(model, epoch, filename="swinunetrv2_model.pt", best_acc=0, dir_add=root_dir):
...
data_dir = "/scratch/u/uanazodo/spark7/data/BraTS/BraTS2021_Training_Data/"
json_list = "/scratch/u/uanazodo/spark7/SWIN_UNETR_v2/SWIN_UNETR_V2_MODEL/brats21_folds.json"
...
max_epochs =   15       
val_every = 5     # changed from 10 to 2
train_loader, val_loader = get_loader(batch_size, data_dir, json_list, fold, roi)


# check data shape and visualize
img_add = os.path.join(data_dir, "/scratch/u/uanazodo/spark7/data/BraTS/BraTS2021_Training_Data/BraTS2021_00214/BraTS2021_00214_t2.nii.gz")
label_add = os.path.join(data_dir, "/scratch/u/uanazodo/spark7/data/BraTS/BraTS2021_Training_Data/BraTS2021_00214/BraTS2021_00214_seg.nii.gz")
...
# Loading State Dict
state_dict = torch.load('/scratch/u/uanazodo/spark7/SWIN_UNETR_v2/SWIN_UNETR_V2_MODEL/swinunetrv2_model.pt')['state_dict']
...
plt.savefig("/scratch/u/uanazodo/spark7/SWIN_UNETR_v2/SLURM_OUT/epoch_val_mean.png")
#plt.show()
...
# save the graph to the current directory
plt.savefig("/scratch/u/uanazodo/spark7/SWIN_UNETR_v2/SLURM_OUT/val_mean_TC_WT_ET.png")
